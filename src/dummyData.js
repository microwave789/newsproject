export const hero = [
    {
      id: 1,
      cover: "../images/hero/hero1.jpeg",
      catgeory: "featured",
      title: "Қант диабетімен ауыратын атақты адамдардың хикаялары",
      authorName: "life.ru ",
      ...
      desc: [
        ...
        {
          para1: "Голливуд жұлдызы, Хэлли Берри - Джеймс Бондтың «Мысық әйел» және басқа да көптеген рөлдерімен танымал болған Голливуд жұлдызы оны түсірудің дәл ортасында нокаутқа түсірген қант диабетімен күресу үшін күш тапты, бірақ ауруды өз пайдасына айналдырды.",
        },
        {
          para2: "Актриса үшін басты ынталандыру оның пішіні мен денсаулығы болды. Дұрыс емес тағамдардан бас тарту және өмір салтын өзгерту жұлдызды бас тартуға мүмкіндік бермеді. Ең көп табыс әкелген фильмдердегі серуендеу рөлдері басты рөлдерге ауыстырылды.",
        },
        {
          para3: "Диабеттік комадан кейінгі жаңа өмір Берридің 22 жасында басталды. Айтпақшы, Бондтың «Басқа күні өл» фильмінде актриса өзінің сұлулығымен және керемет купальникімен ғана емес, сонымен қатар трюктердің көпшілігін өзі жасағанымен де таң қалдырды. Қант диабетімен байланысты шектеулер актрисаның трюктардағы жұмысына әсер еткен жоқ, ол өзі су астында жүзді, пышақпен шайқасты, ұзақ жаттығулардан өтті, тіпті ұшып бара жатқан ұшақты қуып жетті.",
        },
      ],
      details: [
        {
        ...
        { para1: "Шерон Стоун - 1 типті қант диабетімен ауыратын және инсулиннің тұрақты дозасын қажет ететін американдық актриса және продюсер. Стоун оның әдемі келбетінің сыры неде деген сұраққа: «Ешқандай құпия жоқ, мен не істеуім керек болса, бәрін істеймін: дұрыс тамақтану, ұйықтау, жаттығу». Ол «Негізгі инстинкт» (1992) фильміндегі рөлі арқылы танымал болды, онда ол Кэтрин Трамеллдің рөлін сомдады және «Ең үздік актриса» үшін Экран актерлер гильдиясы сыйлығын алды. Бұл сурет бір кездері өзінің сексуалды және арандатушылық сюжеттік желісінің арқасында нағыз сілкініс тудырды, ал Стоун әлемдегі ең сексуалды әйел ретінде танымал болды. Еске салайық, актрисаның бірнеше қатыгез кісі өлтірулерге күдікті болған өлімге әкелетін роман жазушы бейнесі сән, кино және фотосурет тарихында әлдеқашан енген." },
        {
          quote: "Ешқандай құпия жоқ, мен не істеуім керек болса, бәрін істеймін: дұрыс тамақтану, ұйықтау, жаттығу",
        },
        {
          para2: "Шерон Стоун өзінің жұлдызды кино мансабынан басқа, қант диабетімен ашық күресімен де танымал. 2001 жылы оған қант диабеті диагнозы қойылды. Содан бері ол қант диабеті туралы хабардар болу үшін белсенді қорғаушы болды және дамушы елдердегі қант диабетімен ауыратын балаларға күтім көрсететін «Балаға арналған өмір» бағдарламасының жаһандық елшісі ретінде қызмет етеді.",
        },
        {
          para3: "Стоун сонымен қатар қант диабетіне байланысты көптеген қайырымдылық шараларына қатысады және ауру туралы хабардар болу үшін көпшілікке дәрістер оқиды. Ол қант диабеті бойынша білім беру және зерттеу бастамаларын белсенді түрде қолдайды және аурудың алдын алуға және емдеуге бағытталған бағдарламаларды қаржыландырады.",
        },
      ],
    },
    {
  ...
  export const ppost = [
    ...
    },
    {
      id: 3,
      catgeory: "тамақтану",
      title: "Толық аспаздық тәжірибеге арналған үздік 5 мейрамханамыз",
      date: "19. February 2022",
    ...
    },
    {
      id: 4,
      catgeory: "хабар",
      title: "Қант диабетімен ауыратын адам Эверестке қалай көтерілді",
      date: "19. February 2022",
